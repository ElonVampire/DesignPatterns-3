...
{
    internal class RemoveExperienceCommand : ICommand, IChainable
    {
        public ICommand _nextLink { get; set; }
        public string CommandString { get; set; } = "remove experience";
        ...
        protected IResult BuildResult()
        {
            return new Result
            {
                _myResultText = "50 Experience was removed"
            };
        }
    }
}